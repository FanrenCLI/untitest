...
public class UserController_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.example.demo.controller.UserController"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.example.demo.model.UserInfoRequest", false, UserController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.example.demo.service.UserService", false, UserController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
